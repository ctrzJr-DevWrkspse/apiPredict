"""
Disease Prediction API (Symptom Checker)
----------------------------------------

This API predicts the most likely diseases based on a list of symptoms using a trained Random Forest model.
...
4. Example request (from React or curl):
...
CORS is enabled so you can connect from your frontend (React, etc).
"""
